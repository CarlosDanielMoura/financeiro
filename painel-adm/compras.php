                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" onkeyup="criarParcelas()" class="form-control" name="subtotal"
                                    placeholder="SubTotal" id="subtotal" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input onkeyup="criarParcelas()" onchange="criarParcelas()" type="number"
                                    class="form-control" name="parcelas" placeholder="Total Parcelas" id="parcelas"
                                    required value="1">
                            </div>
                        </div>
                            ...
                            <div class="mb-3"><small>
                                    <label for="exampleFormControlInput1" class="form-label">Data (<a
                                        ...
                                        <a title="Lançar Venda para 90 Dias" href="#"
                                            onclick="mudarData('<?php echo $data90 ?>')" class="text-dark">90
                                            Dias</a>)</label>
