...
$vlr_total_via_os = $_POST['valor_payment'];
$qtd_parcelasCart = $_POST['payment_cart_os'];

$desconto_viaOs = $_POST['desconto_cliente']; // Desconto na OS
...
//Verificando tipo de entrada


if($type_entry_client == 'Sem Entrada' and $client_entry_valor > 0){
    echo 'Selecione o TIPO DE ENTRADA POR GENTILEZA!';
    exit();
}
...
$valor_final_venda = (float)$vlr_total_via_os;
