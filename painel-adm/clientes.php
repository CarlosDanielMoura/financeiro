    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form id="form" method="post">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="btn-fechar"  onClick="window.location.reload()">Fechar</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <form id="form-baixar" method="post">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success" onClick="window.location.reload()">Baixar</button>
                </div>
            </form>
        </div>
    </div>
