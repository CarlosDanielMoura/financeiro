...
echo 'Total de tudo: '.$totalLiquido;
echo '<br>';
...
echo 'Total em dinheiro: '. $subtotalDinheiro;
echo '<br>';
...
echo 'Total em Carnê: '. $subtotalCarne;
echo '<br>';
...
echo 'Total Cartão de Crédito: '. $subtotalCartaoCredito;
echo '<br>';
...
echo 'Total Cartão Débito'. $subtotalCartaoDebito;
echo '<br>';
...
echo 'Total em cheque: '. $subtotalCheque;
echo '<br>';
