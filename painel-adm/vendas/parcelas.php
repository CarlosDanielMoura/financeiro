...
$query = $pdo->query("DELETE FROM contas_receber where id_venda = '-1' 
...
$forma_pagamento = $_POST['tipoPagamento'];
...
if($forma_pagamento == 'Carnê'){
	if($parcelas > 1){
		...
		for($i=1; $i <= $parcelas; $i++){
			...
			status = 'Pendente', id_venda = '-1', arquivo = 'sem-foto.jpg'");
